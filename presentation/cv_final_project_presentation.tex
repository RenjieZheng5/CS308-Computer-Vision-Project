...
\institute{Group 8 \quad Southern University of Science and Technology}
...
\begin{frame}[plain]
  ...
  \begin{center}
    ...
    \begin{beamercolorbox}[wd=0.82\textwidth,sep=0.8em,rounded=true,center]{block body}
      ...
      \vspace{0.25em}
      \footnotesize
      Group 8 \quad Southern University of Science and Technology
...
\begin{frame}{COCO Detection Results}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{block}{Key numbers}
      \small
      \begin{itemize}
        \item Grounding DINO: AP 0.421, AP50 0.557, AP75 0.457, AR100 0.536.
        \item YOLO-World: AP 0.366, AP50 0.510, AP75 0.398, AR100 0.547.
        \item OWL-ViT: AP 0.237, AP50 0.385, AP75 0.249, AR100 0.469.
      \end{itemize}
    \end{block}

    \begin{block}{Interpretation}
      \small
      Grounding DINO leads on AP, AP50, and AP75.
      YOLO-World leads on AR100 and speed.
    \end{block}
  \end{columns}
\end{frame}
...
\begin{frame}{Efficiency and Deployment Trade-off}
  \begin{columns}[T,onlytextwidth]
    ...
    \centering
    \includegraphics[width=\linewidth]{../report/figures/efficiency.png}
    ...
    \begin{alertblock}{Takeaway}
      Accuracy and throughput do not rise together. Pick the model by deployment budget.
    \end{alertblock}
  \end{columns}
\end{frame}
...
\begin{frame}{RefCOCO Grounding Results}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{alertblock}{Meaning}
      \small
      RefCOCO is stricter than COCO because it asks for the exact referred instance.
    \end{alertblock}
  \end{columns}
\end{frame}
...
\begin{frame}{Threshold Sensitivity and NMS}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{block}{AP drop}
      ...
      \begin{tabular}{@{}lr@{}}
        \toprule
        OWL-ViT & 0.237 $\rightarrow$ 0.184 \\
        Grounding DINO & 0.421 $\rightarrow$ 0.362 \\
        YOLO-World & 0.366 $\rightarrow$ 0.322 \\
        \bottomrule
      \end{tabular}
    \end{block}

    \begin{block}{NMS diagnostic}
      \scriptsize
      OWL-ViT 100-image subset: AP 0.336 $\rightarrow$ 0.323; AR100 0.520 $\rightarrow$ 0.475.
    \end{block}
